...
/// <summary>
/// Extended <see cref="Avalonia.Controls.ToggleSplitButton"/>.
/// </summary>
public class ToggleSplitButton: Avalonia.Controls.ToggleSplitButton
{
    /// <summary>
    /// Define <see cref="DropDownMenu"/> property.
    /// </summary>
    public static readonly StyledProperty<ContextMenu?> DropDownMenuProperty = AvaloniaProperty.Register<ToggleSplitButton, ContextMenu?>(nameof(DropDownMenu));
    /// <summary>
    /// Define <see cref="IsDropDownOpen"/> property.
    /// </summary>
    public static readonly StyledProperty<bool> IsDropDownOpenProperty = AvaloniaProperty.Register<ToggleSplitButton, bool>(nameof(IsDropDownOpen));
    /// <summary>
    /// Define <see cref="SecondaryButtonClick"/> event.
    /// </summary>
    public static readonly RoutedEvent SecondaryButtonClickEvent = RoutedEvent.Register<ToggleSplitButton, RoutedEventArgs>(nameof(SecondaryButtonClick), RoutingStrategies.Direct);
